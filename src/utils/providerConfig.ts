...
export const PROVIDER_CONFIGS: Record<string, ProviderConfig> = {
  ...
  'thudm-glm-z1-32b': {
    ...
    apiKeyFormat: 'glm-...',
    logoUrl: '/logos/huggingface-color.png',
    color: '#FF6B6B',
    hasWalletBalance: true,
    balanceCheckUrl: 'https://open.bigmodel.cn/api/paas/v3/user/info',
    contextLength: 33000,
    inputPricing: 0.04,
    outputPricing: 0.14,
    provider: 'THUDM',
  ...
  'zai-glm-4-5': {
    ...
    logoUrl: '/logos/huggingface-color.png',
    color: '#9333EA',
    hasWalletBalance: false, // CORS blocked in browser
    balanceCheckUrl: 'https://api.z.ai/v1/user/balance',
    contextLength: 128000,
    inputPricing: 0.03,
    outputPricing: 0.12,
    provider: 'Z.ai',
  ...
  'elevenlabs-v2': {
    ...
    color: '#10B981',
    hasWalletBalance: true,
    balanceCheckUrl: 'https://api.elevenlabs.io/v1/user',
    provider: 'ElevenLabs',
    capabilities: ['voice-synthesis', 'voice-cloning', 'multilingual'],
    specialFeatures: ['Voice cloning', 'Emotion control', 'Character-based billing'],
  ...
  'suno-v4': {
    ...
    color: '#FF6B35',
    provider: 'Suno',
    capabilities: ['music-generation', 'composition', 'voice-synthesis'],
    specialFeatures: ['Lyric generation', 'Multiple genres', 'Custom vocals'],
    company: 'Suno'
  },
  'openai-whisper': {
    name: 'openai-whisper',
  ...
  'ollama': {
    ...
    costPerUnit: 0.00,
    description: 'Local LLM runtime for development and experimentation',
    apiKeyFormat: 'ollama-...',
    logoUrl: '/logos/ollama.png',
    color: '#000000',
    provider: 'Ollama',
    capabilities: ['local-inference', 'model-switching', 'privacy'],
    specialFeatures: ['No API costs', 'Offline capable', 'Multiple models'],
    company: 'Ollama'
  },
  'cursor-ai': {
    name: 'cursor-ai',
  ...
  elevenlabs: {
    name: 'elevenlabs',
    displayName: 'ElevenLabs (Generic)',
    usageMetric: 'characters',
    usageUnit: 'characters',
    category: 'audio',
    costPerUnit: 0.00003,
    description: 'ElevenLabs API access for voice synthesis',
    apiKeyFormat: 'sk-...',
    logoUrl: '/logos/elevenlabs.png',
    color: '#10B981',
    hasWalletBalance: true,
  ...
  // Additional Providers for available logos
  'grok': {
    name: 'grok',
    displayName: 'Grok',
    usageMetric: 'tokens',
    ...
    color: '#1DA1F2',
    provider: 'xAI',
    capabilities: ['real-time-data', 'reasoning', 'conversational'],
    specialFeatures: ['Twitter integration', 'Current events', 'Humor'],
    company: 'xAI'
  },
  'perplexity': {
    name: 'perplexity',
    ...
    apiKeyFormat: 'pplx-...',
    logoUrl: '/logos/perplexity-color.png',
    color: '#20B2AA',
    provider: 'Perplexity',
    capabilities: ['search', 'reasoning', 'citation', 'real-time-data'],
    specialFeatures: ['Source citations', 'Real-time search', 'Academic focus'],
    company: 'Perplexity AI'
  },
  'bytedance': {
    name: 'bytedance',
    displayName: 'ByteDance AI',
    usageMetric: 'tokens',
    usageUnit: 'tokens',
    category: 'multimodal',
    costPerUnit: 0.001,
    description: 'ByteDance\'s multimodal AI capabilities',
    apiKeyFormat: 'bd-...',
    logoUrl: '/logos/bytedance-color.png',
    color: '#FF0050',
    provider: 'ByteDance',
    capabilities: ['multimodal', 'video-understanding', 'content-generation'],
    specialFeatures: ['Video AI', 'Content moderation', 'Recommendation systems'],
    company: 'ByteDance'
  }
}
